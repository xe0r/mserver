...
Player.prototype.setFilename = function(filename) {
  if (this.xhr) {
    this.xhr.abort();
    this.xhr = null;
  }
  ...
  this.xhr.onreadystatechange = this.xhr.onreadystatechange.bind(this);
  this.xhr.send();
...
window.addEventListener('load', function(e){
  var player = new Player(document.getElementById('node'));
